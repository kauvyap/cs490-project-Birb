  ...
  if (location.pathname === "/login" || location.pathname === "/signup"){
      ...
      return (
        ...
        <VStack align="start" height={"100vh"} width="200px" spacing={4} p={4} bg={bg} alignItems={"center"}>
          ...
          <Button data-testid="planDay" fontFamily={"'DM Sans', sans-serif"} height={"54px"} borderRadius={"14px"} variant="outline" color={"white"} fontSize={"18px"} fontWeight={"700"} width={"160px"} isDisabled={location.pathname !== "/"}>Plan Day</Button>
          <Spacer></Spacer>
